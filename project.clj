(defproject conference-om "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "conference-om.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main conference-om.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "conference-om.core/on-figwheel-reload"}

                :compiler {:main conference-om.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/conference_om.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main conference-om.test-runner
                           :optimizations :none}}
